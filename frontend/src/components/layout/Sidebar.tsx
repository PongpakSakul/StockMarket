...
const navItems = [
  ...
  { href: '/dividends', label: 'Dividends', icon: DividendsIcon },
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="flex items-center gap-2 px-6 py-5 border-b border-gray-100">
        <svg className="h-8 w-8 text-blue-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
      ...
      <div className="px-6 py-4 border-t border-gray-100">
        <p className="text-xs text-gray-400">Stock Portfolio Tracker</p>
      </div>
    </aside>
  );
}
...
function DividendsIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
